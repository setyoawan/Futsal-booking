<?php 
	...
	$user = query("SELECT * FROM booking WHERE id = $id")[0];
...
<div class="container">
	<div class="row">
		...
		<h1>Form edit data pemesanan!</h1>
		</div>
	</div>
	...
	<div class="row">
		...
		<input class="form-control shadow" type="text" name="username" id="nama" required="required" value="<?php echo $user["username"]; ?>"> 
		<br>
